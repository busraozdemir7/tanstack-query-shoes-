...
const Gender = ({ selected, setSelected }: SelectedProps) => {
    ...
    useEffect(() => {
        if (selected.length > 0) {
            // seçili cinsiyet varsa aralarına , koyup url'e ekle
            params.set("gender", selected.join(","));
            setParams(params);
        } else {
            // seçili cinsiyet yoksa url'de parametreyi kaldır
    ...
    return (
        <div>
            ...
            <div className="flex items-center gap-4">
                ...
                <label htmlFor="men" className="font-semibold select-none">Erkek</label>
            </div>
